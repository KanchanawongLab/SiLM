...
// Definition of the Gaussian derivative library modified from the one by K. Lidke
...
__device__ void kernel_DerivativeGauss2D_nbg(int ii, int jj,float* theta, float* pold1, float *dudt, float *model) ;

__device__ void kernel_DerivativeGauss_nbg(int ii, int jj,float* theta, float* pold1, float *dudt, float *model) ;
