...
// fit psf with least squre error using l-m algorithm, sigmax and sigmay are output
...
__global__ void kernel_gpustorm_fitsigmaxy(float *data,  float *fitresult, float *fiterror,const int iterations, const int sz, const float psfSigma){
